...
This code book relates to the tidydata.txt file.

Readme.md provides additional information regarding this data set. 
...
Subject - subject ID
Activity - The type of activity occuring while measurements taken
